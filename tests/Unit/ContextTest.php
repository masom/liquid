...
class ContextTest extends \Liquid\Tests\TestCase
{
    ...
    {
        $this->context['dynamic'] = array("lambda" => function () {
                return 'Hello';
            });
    ...
    {
        $this->context['dynamic'] = array(1, 2, function () {
            return 'Hello';
        }, 4, 5);
    ...
    {
        $global = 0;
        $this->context['callcount'] = function () use (&$global) {
            $global += 1;
    ...
    {
        $global = 0;
        $this->context['callcount'] = array("lambda" => function () use (&$global) {
                $global += 1;
                return (string)$global;
            });
    ...
    public function test_access_to_context_from_proc()
    {
        ...
        $this->context['magic'] = function ($context) {
            $registers = $context->registers();
            return $registers['magic'];
        };
